...
def main(show_plot=True, animate=True):
    ...
    model = biorbd.Model("../../model_msk/simplified_UL_Seth_pedal_aligned_for_inverse_kinematics.bioMod")
    ...
    # pyorerun animation
    if animate:
        biorbd_model = biorbd.Model("../../model_msk/simplified_UL_Seth_pedal_aligned.bioMod")
