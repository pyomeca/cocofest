...
class DingModelIntensityFrequencyIntegrate(DingModelFrequencyIntegrate):
    """
    ...
    def __init__(
        ...
        super(DingModelIntensityFrequencyIntegrate, self).__init__(
    ...
    def cn_sum_fun(
        ...
        for i in range(len(t_stim_prev)):
            ...
            sum_multiplier += lambda_i * ri * exp_time * coefficient  # Part of Eq n°1
