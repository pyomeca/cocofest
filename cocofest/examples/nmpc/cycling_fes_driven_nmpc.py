...
from cocofest import DingModelPulseDurationFrequencyWithFatigue, NmpcFesMsk, FesMskModel, PickleAnimate, SolutionToPickle
...
model = FesMskModel(name=None,
                    ...
                    muscles_model=[DeltoideusClavicle_A_model,
...
SolutionToPickle(sol[0], "cycling_fes_driven_nmpc_full_force.pkl", "").pickle()
[SolutionToPickle(sol[1][i], "cycling_fes_driven_nmpc_" + str(i) + "_force.pkl", "").pickle() for i in range(len(sol[1]))]

# biorbd_model = biorbd.Model("../msk_models/simplified_UL_Seth_full_mesh.bioMod")
# PickleAnimate("cycling_fes_driven_nmpc_full.pkl").animate(
#     model=biorbd_model
# )
...
SolutionToPickle(sol[0], "cycling_fes_driven_nmpc_full_fatigue.pkl", "").pickle()
[SolutionToPickle(sol[1][i], "cycling_fes_driven_nmpc_" + str(i) + "_fatigue.pkl", "").pickle() for i in range(len(sol[1]))]
