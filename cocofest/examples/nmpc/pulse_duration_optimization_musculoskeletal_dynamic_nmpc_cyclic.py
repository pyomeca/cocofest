...
from cocofest import DingModelPulseDurationFrequencyWithFatigue, NmpcFesMsk, FesMskModel, SolutionToPickle, PickleAnimate
...
PickleAnimate(temp_pickle_file_path).animate(
    model=biorbd_model
)
